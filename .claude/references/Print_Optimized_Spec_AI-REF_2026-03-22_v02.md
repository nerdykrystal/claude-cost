...
**Scope:** All print-optimized `.docx` files produced by or for Stahl Systems.  
...
Header: "Stahl Systems — [Document Title]" right-aligned | 9pt Lato italic #888888
...
- **Content:** `Stahl Systems — [Document Title]` (or as specified by author)
...
2. Author(s)
3. Organization — default: `Stahl Systems`
...
- This spec applies to **all** Stahl Systems print-ready `.docx` output unless the author explicitly overrides a setting.
...
- Versioning: follow the Stahl Systems Document Versioning System when naming and tagging output files.
